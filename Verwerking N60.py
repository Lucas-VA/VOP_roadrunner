...
plt.plot(t_Dick, az_Dick, label='verticale versnelling in koffernode')
plt.legend()
...
plt.figure()
plt.plot(t_Dick, snelh_Dick, label='integratie koffernode')
plt.plot(t_GPS, vx_GPS_Dick, label='GPS snelheid koffernode')
plt.legend()
plt.title('GPS-snelheid')
plt.xlabel('tijd [s]')
...
plt.figure()
plt.plot(t_laser, az_laser, label='verticale versnelling in lasernode')
plt.plot(t_Dick[:-900], az_Dick_new, label='verticale versnelling in koffernode')
plt.legend()
plt.title('z-acceleratie in functie van de tijd, N60')
plt.xlabel('tijd [s]')
plt.ylabel('z-acceleratie [m/s²]')
...
plt.figure()
plt.plot(t_Dick[:-900], snelh_Dick_new, label='integratie koffernode')
plt.plot(t_GPS, vx_GPS_Dick, label='GPS snelheid koffernode')
plt.legend()
plt.title('GPS-snelheid')
plt.xlabel('tijd [s]')
